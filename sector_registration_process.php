...
$sql = "INSERT INTO users (firstname, lastname, phone_number, password, otp, verified, otp_used, otp_login, terms, created_at,role) 
        VALUES (:firstname, :lastname, :phone_number, :password, :otp, 0, 0, 0, :terms, NOW(),'Sector')";
